    ...
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
            ...
            // increase maximum cache size to allow large license files if present
            maximumFileSizeToCacheInBytes: 25 * 1024 * 1024,
            // exclude packaging artifacts and very large unexpected files
            globIgnores: ['**/win-unpacked/**', '**/*.map', '**/app.asar/**', '**/LICENSES.chromium.html']
        },
        ...(withCOIServiceWorker
          ? {
              injectRegister: null,
